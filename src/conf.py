...
# KageSenshi's Logs build configuration file, created by
# `ablog start` on Fri Feb 12 01:25:09 2021.
#
...
blog_title = u'KageSenshi\'s Logs Blog'

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = u'http://blog.kagesenshi.org'
...
blog_authors = {
    'Izhar Firdaus (kagesenshi)': ('Izhar Firdaus (kagesenshi)', None),
}
...
project = u'KageSenshi\'s Logs'
copyright = u'2021, Izhar Firdaus (kagesenshi)'
author = u'Izhar Firdaus (kagesenshi)'
